...
class orderModel(models.Model):
    ...
    order_no = models.CharField(default="",null=True, blank=True,max_length=100, verbose_name='订单编号')
    ...
    order_type = models.CharField(max_length=100, default='代充', verbose_name='订单类型')
    ...
    @classmethod
    def get_type_today_orders(cls,type):
        today = timezone.now().date()
        return cls.objects.filter(created_at__date=today,account_type=type).count()